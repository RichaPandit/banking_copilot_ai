...
* Established connection to banking-ai-mcp-hpg8e8d7dxe0hkf0.uksouth-01.azurewebsites.net (51.104.28.84 port 443) from 192.168.1.161 port 61907
* using HTTP/1.x
> POST /mcp/ HTTP/1.1
...
< Date: Wed, 10 Dec 2025 14:36:29 GMT
< Server: uvicorn
<
